    ...
    <section class="content">
      ...
      <h2 class="global_title"><i class="fa fa-building-o"></i> Add Client Record</h2>
		<div class="main_info_sec">
            <?php echo $this->Form->create($client,  array('id' => 'fileupload', 'class' => 'form-horizontal form-request check-form add-property {is_required:"false"}  js-normal-fileupload', 'enctype' => 'multipart/form-data'));?>
				<div class="global_form">
					<div class="row">
						<div class="col-lg-6 col-sm-12 col-xs-12">
							<div class="form_block">
								<label class = "nitin">Company<span class="clor"> * </span> :</label>
							    <?php echo $this->Form->input('company_id', array('type' => 'select', 'options'=> $company,'required' => 'required', 'class' => 'input_field','label' => false));  ?>
							</div>
						</div>
					...
					<div class="row">
						<div class="col-lg-6 col-sm-12 col-xs-12">
							<div class="form_block">
							  ...
							  <?php
							  $option = ['1'=>'Yes','2'=>'No'];
							  echo $this->Form->select('status', $option, array('required' => 'required', 'class' => 'input_field', 'label' => false,'id'=>'immigra_card_expiry_date'));  ?>
							</div>
						</div>
						<div class="col-lg-6 col-sm-12 col-xs-12">
							<div class="form_block">
