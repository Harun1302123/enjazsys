  ...
  <h2 class="global_title"><i class="fa fa-building-o"></i> Manage Clients</h2>
   <div class="main_info_sec">
	   <div class="row" style="margin-bottom:1%;padding:0 20px 10px">
		   <div class="col-lg-12">
			   <a href="/admin/clients/add" class="btn btn-info"><i class="fa fa-plus"></i> Add Record </a>
		   </div>
	   </div>
		<style>
	...
	<div class="table_listing rep_content">
		...
		<div class="table-responsive">
			<table class="table table-bordered table-hover">
				<thead>
					<tr>
						<th align='left'><?php echo $this->Paginator->sort('company_id', 'Company Name');?></th>
					...
					if($clients){
						...
						<tr>
							...
							<td><?php echo date('j F,Y',strtotime($clients['created']));?></td>
							<td>
							<?php

								$edit = '<a href="'.BASE_URL.'/admin/clients/edit/'.base64_encode($clients->id).'">
