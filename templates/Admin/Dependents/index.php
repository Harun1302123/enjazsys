<?php echo $this->element('admin/tabular/title', ['title' => 'Manage Dependants', 'faClass' => "fa fa-building"]); ?>
    ...
    <div class="card-header border-0 pt-6">
        ...
        <div class="card-toolbar">
            ...
            <div class="d-flex justify-content-end" data-kt-user-table-toolbar="base">
                ...
                <!--begin::Add user-->
                <a href="<?php  echo $this->request->getAttribute('webroot');  ?>admin/dependents/add" class="btn btn-primary">
                    ...
                    <div class="modal-content">
                        ...
                        <div class="modal-body scroll-y mx-5 mx-xl-15 my-7">
                            ...
                            <form
                                ...
                                method="post"
                                action="<?php echo $this->request->getAttribute('webroot'); ?>admin/dependents/upload_attachment"
                                autocomplete="off"
						...
						<tr>
							...
							<?php
                                echo $this->element(
                                    ...
                                    [
                                        'editLink' => 'admin/dependents/edit/',
                                        'deleteLink' => '/admin/dependents/delete/',
                                        'id' => $dependent->id,
                                        'isAttachement' => true,
                                    ]
                                )
