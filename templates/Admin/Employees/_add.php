...
<section class="content">
  ...
  <div class="main_info_sec"> <?php echo $this->Form->create($employee,array('id' => 'fileupload', 'class' => 'form-horizontal form-request check-form add-property {is_required:"false"}  js-normal-fileupload', 'enctype' => 'multipart/form-data','url'=>'/admin/employees/add/dependent'));?>
        ...
        <fieldset>
          ...
          <div class="col-lg-6 col-sm-12 col-xs-12">
            <div class="form_block">
              ...
              <?php echo $this->Form->input('company_id', array('type' => 'select', 'options'=>$companies,'required' => 'required', 'class' => 'input_field', 'label' => false));  ?> </div>
          </div>
          <div class="col-lg-6 col-sm-12 col-xs-12">
            <div class="form_block">
          ...
          <div class="col-lg-6 col-sm-12 col-xs-12">
            <div class="form_block">
              ...
              <?php echo $this->Form->input('mobile_no', array('class' => 'input_field', 'label' => false));  ?>
              </div>
          </div>
          <div class="col-lg-6 col-sm-12 col-xs-12">
            <div class="form_block">
            ...
            <table class="table borderless">
              <tr>
                ...
                <td width="20%"> Received by Daman</br>
                  <input style="opacity: 1; margin-left: 0px; position: relative;" value='1' name="passport_receive_admin" type="checkbox"  class="regular-checkbox" />
                  <input  name="passport_receive_admin_date" type="hidden"  class="regular-checkbox" /></td>
                <td width="20%">Sent to Client</br>
                  <input style="opacity: 1; margin-left: 0px; position: relative;" value='1' name="passport_send_admin" type="checkbox" class="regular-checkbox" />
                  <input  name="passport_send_admin_date" type="hidden"  class="regular-checkbox" /></td>
              </tr>
              <tr>
                <td width="10%">Birthday Certificate: </td>
                <td width="20%"> Received by Daman</br>
                  <input style="opacity: 1; margin-left: 0px; position: relative;" value='1' name="bc_receive_admin" type="checkbox"  class="regular-checkbox" />
                  <input  name="bc_receive_admin_date" type="hidden"  class="regular-checkbox" /></td>
                <td width="20%">Sent to Client</br>
                  <input style="opacity: 1; margin-left: 0px; position: relative;" value='1' name="bc_send_admin" type="checkbox" class="regular-checkbox" />
                  <input  name="bc_send_admin_date" type="hidden"  class="regular-checkbox" /></td>
              </tr>
              <tr>
                <td width="10%">Marriage Certificate: </td>
                <td width="20%"> Received by Daman</br>
                  <input style="opacity: 1; margin-left: 0px; position: relative;" value='1' name="mc_receive_admin" type="checkbox"  class="regular-checkbox" />
                  <input  name="mc_receive_admin_date" type="hidden"  class="regular-checkbox" /></td>
                  </td>
                <td width="20%">Sent to Client</br>
                  <input style="opacity: 1; margin-left: 0px; position: relative;" value='1' name="mc_send_admin" type="checkbox" class="regular-checkbox" />
                  <input  name="mc_send_admin_date" type="hidden"  class="regular-checkbox" /></td>
              </tr>
              <tr>
                <td width="10%">Emirates ID: </td>
                <td width="20%"> Received by Daman</br>
                  <input style="opacity: 1; margin-left: 0px; position: relative;" value='1' name="eid_receive_admin" type="checkbox"  class="regular-checkbox" />
                  <input  name="eid_receive_admin_date" type="hidden"  class="regular-checkbox" /></td>
                <td width="20%">Sent to Client</br>
                  <input style="opacity: 1; margin-left: 0px; position: relative;" value='1' name="eid_send_admin" type="checkbox" class="regular-checkbox" />
                  <input  name="eid_send_admin_date" type="hidden"  class="regular-checkbox" /></td>
              </tr>
              <tr>
                <td width="10%">Degree Certificate: </td>
                <td width="20%"> Received by Daman</br>
                  <input style="opacity: 1; margin-left: 0px; position: relative;" value='1' name="dc_receive_admin" type="checkbox"  class="regular-checkbox" />
                  <input  name="dc_receive_admin_date" type="hidden"  class="regular-checkbox" /></td>
                <td width="20%">Sent to Client</br>
                  <input style="opacity: 1; margin-left: 0px; position: relative;" value='1' name="dc_send_admin" type="checkbox" class="regular-checkbox" />
                  <input  name="dc_send_admin_date" type="hidden"  class="regular-checkbox" /></td>
              </tr>
              <tr>
                <td width="10%">Medical: </td>
                <td width="20%"> Received by Daman</br>
                  <input style="opacity: 1; margin-left: 0px;  position: relative;" value='1' name="medical_receive_admin" type="checkbox"  class="regular-checkbox" />
                  <input  name="medical_receive_admin_date" type="hidden"  class="regular-checkbox" /></td>
                <td width="20%">Sent to Client</br>
                  <input style="opacity: 1; margin-left: 0px; position: relative;" value='1' name="medical_send_admin" type="checkbox" class="regular-checkbox" />
                  <input  name="medical_send_admin_date" type="hidden"  class="regular-checkbox" /></td>
              </tr>
              <tr>
                <td width="10%">Other: </td>
                <td width="20%"> Received by Daman</br>
                  <input style="opacity: 1; margin-left: 0px; position: relative;" value='1' name="other_receive_admin"  type="checkbox"  class="other_doc regular-checkbox" />
                  <input  name="other_receive_admin_date" type="hidden"  class="regular-checkbox" /></td>
                <td width="20%">Sent to Client</br>
                  <input style="opacity: 1; margin-left: 0px; position: relative;" value='1' name="other_send_admin"  type="checkbox" class="other_doc regular-checkbox" />
                  <input  name="other_send_admin_date" type="hidden"  class="regular-checkbox" /></td>
              </tr>
            </table>
          </div>
        </fieldset>
      ...
      <div class="row">
        <!-- <div class="col-lg-3 col-sm-12 col-xs-12">
							<div class="global_btn_info">
								<button class="save" type="" name="skip"  value="skip"><i class="fa fa-floppy-o"></i> SKIP</button>
							</div>
						</div> -->
      ...
      <div class="row">
        <!--<div class="col-lg-6 col-sm-6 col-xs-12">
          <div class="global_btn_info">
            ...
            <?php //echo $this->Form->input('files[]', array('style'=>'display:none;','type' => 'file','multiple'=>'multiple', 'class' => 'input_field file', 'label' => false));  ?>
        ...
        <div class="col-lg-6 col-sm-12 col-xs-12 pull-right">
          <div class="global_btn_info">
            <button class="save" id="submit" type="button" name="next" value="next"><i class="fa fa-floppy-o"></i> NEXT</button>
          </div>
        </div>
      </div>
    </div>
   ...
   webroot = '<?php echo BASE_URL; ?>';
	...
	$(".person_documents input").change(function() {
    	if(this.checked) {
			...
			date = new Date()
			$('input[name="'+$(this).attr('name')+'_date"]').val(date.getFullYear()+'-'+ (date.getMonth()+1) +'-'+ date.getDate()); //$(this).attr('name')
		}else{
	...
	$('.other_doc').change(function() {
		if(this.checked) {
			...
			$(this).parent('td').append('<div  class="other-doc-parent form_block"><input  name="'+name+'_value" type="text"  class="input_field" style="width: 90%" required /></div>');
		}else{
