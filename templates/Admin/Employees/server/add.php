    ...
    <section class="content">
      ...
      <h2 class="global_title"><i class="fa fa-building-o"></i> Add Employee</h2>
		<div class="main_info_sec">	
            <?php echo $this->Form->create($employee,array('id' => 'fileupload', 'class' => 'form-horizontal form-request check-form add-property {is_required:"false"}  js-normal-fileupload', 'enctype' => 'multipart/form-data','url'=>'/admin/employees/add/dependent'));?>
                    ...
                    <div class="col-lg-6 col-sm-6 col-xs-12">
                        ...
                        <div class="col-lg-6 col-sm-12 col-xs-12">
							<div class="form_block">
							  ...
							  <?php echo $this->Form->text('status_change_date', array('required' => 'required', 'class' => 'input_field date_expiry', 'label' => false));  ?>
							</div>
						</div>
                        ...
                        <div class="col-lg-6 col-sm-12 col-xs-12">
							<div class="form_block">
							  ...
							  <?php echo $this->Form->text('s_basic', array('required' => 'required', 'class' => 'input_field', 'label' => false));  ?>
							</div>
						</div>
                        ...
                        <div class="col-lg-6 col-sm-12 col-xs-12">
							<div class="form_block">
							  ...
							  <?php echo $this->Form->text('accomodation', array('required' => 'required', 'class' => 'input_field', 'label' => false));  ?>
							</div>
						</div>
                        ...
                        <div class="col-lg-6 col-sm-12 col-xs-12">
							<div class="form_block">
							  ...
							  <?php echo $this->Form->text('transportion', array('required' => 'required', 'class' => 'input_field', 'label' => false));  ?>
							</div>
						</div>
                        ...
                        <div class="col-lg-6 col-sm-12 col-xs-12">
							<div class="form_block">
							  ...
							  <?php echo $this->Form->text('others', array('required' => 'required', 'class' => 'input_field', 'label' => false));  ?>
							</div>
						</div>
