...
<div class="content-wrapper"> <?php echo  $this->Flash->render();?>
  ...
  <section class="content">
    ...
    <h2 class="global_title"><i class="fa fa-building-o"></i>Dependents Report</h2>
          ...
          <div class="row">
            ...
            <div class="col-md-3">
              <div class="form_block" >
                ...
                <?php echo $this->Form->input('company_id',['id' => 'company-id', 'type' => 'select', 'options'=>$companies,'label'=>false,'div'=>false ,'empty'=>'Select Company','class'=>"form-control"]); ?> </div>
            </div>
            <div class="col-md-3 hide">
              <div class="form_block" >
                <label for="for_whom">Category:</label>
                <?php echo $this->Form->input('for_whom',['id' => 'for-whom', 'type' => 'select', 'options'=>['1'=>'Employees','2'=>'Dependent'],'label'=>false,'div'=>false ,'empty'=>'Select Category','class'=>"form-control"]); ?> </div>
            </div>
            <div class="col-md-3">
              <div class="form_block">
            ...
            <div class="col-md-3  dependet-textbox">
              <div class="form_block">
            ...
            <div class="col-md-3">
              <div class="form_block">
                ...
                <?php
					 echo $this->Form->input('expired_type',array('type' => 'select', 'options'=>[''=>'Select Type','passport_expired'=>'Passport Expired','visa_expired'=>'Visa Expired' , 'emirates_id_expired' => 'Emirates ID Expired' , 'health_card_exp_date' => 'Insurance'], 'class' => 'input_field','label' => false ));  ?>
              </div>
            </div>
          ...
          <table class="table table-bordered table-hover">
            <thead>
              <tr>
                ...
                <th align='left'><?php echo $this->Paginator->sort('name', 'EMPLOYEE NAME');?></th>
                <td align="left">DEPENDENTS NAME</td>
                <td align='left'><?php echo 'RELATION';?></td>
