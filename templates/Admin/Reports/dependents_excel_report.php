...
<thead>
	<tr bgcolor="#C8FD03">
        ...
        <th align="center">DEPENDENTS NAME </th>
    ...
    <?php
		...
		<tr>
            ...
            <th align='center'><?php echo $this->DateC->DateFormetforViewReport($full_trans_record['passport_exp_date']); ?></th>
            <th align='center'><?php echo $full_trans_record['visa_no']; ?></th>
            <th align='center'><?php echo $this->DateC->DateFormetforViewReport($full_trans_record['visa_exp_date']); ?></th>
            <th align='center'><?php echo $full_trans_record['emiratesID_no'];?></th>
            <th align='center'><?php echo $this->DateC->DateFormetforViewReport($full_trans_record['emiratesID_exp_date']);?></th>
            <th align='center'><?php echo $this->DateC->DateFormetforViewReport($full_trans_record['health_card_exp_date']);?></th>
