...
<table class="table ">
    ...
    <tr>
        ...
        <tr><td><h5>Comments: EmiratesID Expiry(<?php echo $_GET['start_date_ex_type']; ?> - <?php echo $_GET['end_date_ex_type']; ?>)</h5></td></tr>
	...
	<?php  if(!$full_trans_records->isEmpty()){
		...
		<tr>																
			...
			<td><?php echo $full_trans_record['mobile_no']; ?></td>
                ...
                <td><?php echo $this->DateC->DateFormetforViewReport($full_trans_record['passport_exp_date']); ?></td>
                <td><?php echo $full_trans_record['visa_no']?></td>
                <td><?php echo $this->DateC->DateFormetforViewReport($full_trans_record['visa_exp_date']); ?></td>
                <td><?php echo $full_trans_record['emiratesID_no']?></td>
                <td><?php echo $this->DateC->DateFormetforViewReport($full_trans_record['emiratesID_exp_date']) ; ?></td>
                <td><?php echo $full_trans_record['labor_card_no']?></td>
                <td><?php echo $this->DateC->DateFormetforViewReport($full_trans_record['labor_card_exp_date']); ?></td>
                <td><?php echo $full_trans_record['health_card_no']?></td>
                <td><?php echo $this->DateC->DateFormetforViewReport($full_trans_record['health_card_exp_date']); ?></td>
            ...
            <td><?php echo $this->DateC->DateFormetforViewReport($full_trans_record['created']); ?></td>
		</tr>
		<?php } ?>
