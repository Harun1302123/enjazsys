...
<table class="table table-bordered table-hover">
  <thead>
    ...
    <tr>
        <td>
            <?php
                if ($SendAlert_dataRow->for_whom == 2) {
                    if (isset($SendAlert_dataRow->dependent->employee->company)) {
                        echo $SendAlert_dataRow->dependent->employee->company->name;
                    }
                } else {
                    if (isset($SendAlert_dataRow->employee->company)) {
        ...
        <td align='left'>
            <?php echo $SendAlert_dataRow->alert_type->name; ?>
        </td>
        <td align='left'>
            <?php echo $this->DateC->DateFormetforViewReport($SendAlert_dataRow->created); ?>
        </td>
    </tr>
    <?php
				}
