...
<section class="content">
  ...
  <div class="main_info_sec"> <?php echo $this->Form->create($setting,  array('id' => 'fileupload', 'class' => 'form-horizontal form-request check-form add-property   js-normal-fileupload', 'enctype' => 'multipart/form-data'));?>
    <div class="global_form">
      ...
      <div class="col-lg-6 col-sm-12 col-xs-12 hide">
        <div class="form_block">
          <label class = "nitin">Alert Before<span class="clor"> * </span> :</label>
          <?php echo $this->Form->input('alert_bf', array('required' => 'required', 'class' => 'input_field','min'=>'0', 'label' => false));  ?> </div>
      </div>
      <div class="col-lg-6 col-sm-12 col-xs-12">
        <div class="form_block">
          <label class = "nitin">CC-Emails (separated with ,)<span class="clor"> * </span> :</label>
          <?php echo $this->Form->input('cc_emails', array('required' => 'required', 'maxlength'=>300, 'class' => 'input_field','min'=>'0', 'label' => false));  ?> </div>
      </div>
    </div>
    <div class="row">
