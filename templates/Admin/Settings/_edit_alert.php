                        ...
                        <div class="clearboth" ></div>
						 ...
						 <div class="col-lg-12 col-sm-12 col-xs-12">
							<div class="form_block" >
                                ...
                                <?php echo $this->Form->textarea('alert_text_emp', array('type' => 'select', 'options'=>$alert_types,  "id" => "alert_text_emp" , 'style' => 'height: 200px;', 'required' => 'required', 'class' => 'input_field', 'label' => false));  ?>
