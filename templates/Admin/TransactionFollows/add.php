					...
					<div class="row">
						<div class="col-lg-6 col-sm-12 col-xs-12">
							<div class="form_block">
								...
								<?php echo $this->Form->select('company_id', $company,array('required' => 'required', 'class' => 'input_field', 'label' => false,'empty' => '--Select Company--')); ?>				
							</div>
						</div>
						...
						<div class="col-lg-6 col-sm-12 col-xs-12">
							<div class="form_block">
								...
								<?php echo $this->Form->select('transaction_id',$transData,array('required' => 'required', 'class' => 'input_field', 'label' => false,'empty'=>'-- Select Transaction --'));  ?>
							</div>
						</div>						
					</div>	
					...
					<div class="row">						
						<div class="col-lg-6 col-sm-12 col-xs-12">
							<div class="form_block">
								...
								<?php								
								echo $this->Form->select('transaction_type', $typesData,array('required' => 'required', 'class' => 'input_field', 'label' => false,'empty'=>'-- Select Transaction Type--'));  ?>
							</div>
						</div>  
						...
						<div class="col-lg-6 col-sm-12 col-xs-12">
							<div class="form_block">
							  ...
							  echo $this->Form->select('for_whom', $for_whom, array('required' => 'required', 'class' => 'input_field', 'label' => false,'empty'=>'-- Select For Whom --'));  ?>
							</div>
						</div>
					</div>
					...
					<div class="row">						
						...
						<div class="col-lg-6 col-sm-12 col-xs-12">
							<div class="form_block">
							  ...
							  <?php echo $this->Form->input('starting_date',array('required' => 'required', 'class' => 'input_field','id'=>'start_date','label' => false));  ?>
							</div>
						</div>
					</div>	
					...
					<div class="row">						
						<div class="col-lg-6 col-sm-12 col-xs-12">
							<div class="form_block">
							  ...
							  <?php echo $this->Form->select('status', $statusData,array('required' => 'required', 'class' => 'input_field','empty'=>'--Select Status--','label' => false));  ?>
							</div>
						</div>  
						...
						<div class="col-lg-6 col-sm-12 col-xs-12">
							<div class="form_block">
							  ...
							  <?php echo $this->Form->input('note', array('required' => 'required', 'class' => 'input_field', 'label' => false));  ?>
							</div>
						</div>
					</div>
					...
					<div class="row">						
						<div class="col-lg-6 col-sm-12 col-xs-12">
							<div class="form_block">
							  ...
							  <?php 
							  $options = ['1'=>'Yes','2'=>'No'];
							  echo $this->Form->select('trans_finish', $options,array('required' => 'required', 'class' => 'input_field','empty'=>'-- Select Tranasction Finish--','label' => false));  ?>
							</div>
						</div>  
						...
						<div class="col-lg-6 col-sm-12 col-xs-12">
							<div class="form_block">
							  ...
							  <?php echo $this->Form->input('completion_date', array('required' => 'required', 'class' => 'input_field', 'id'=>'complete_date','label' => false));  ?>
							</div>
						</div>
					</div>
