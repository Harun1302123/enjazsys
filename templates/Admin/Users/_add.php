...
<div class="content-wrapper">
    ...
    <section class="content">
      ...
      <h2 class="global_title"><i class="fa fa-building-o"></i> Add User </h2>
					...
					<div class="row">
						<div class="col-lg-6 col-sm-12 col-xs-12">
							<div class="form_block">
							  ...
							  echo $this->Form->input('status', array('type' => 'select', 'options'=>$status,'required' => 'required', 'class' => 'input_field', 'label' => false,'id'=>'immigra_card_expiry_date'));  ?>
							</div>
						</div>
						<div class="col-lg-6 col-sm-12 col-xs-12">
							<div class="form_block">
