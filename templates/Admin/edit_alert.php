					...
					<div class="row">
						<div class="col-lg-6 col-sm-12 col-xs-12">
							<div class="form_block">
							    ...
							    <?php echo $this->Form->input('alert_type_id', array('options'=>$alert_types,'required' => 'required', 'class' => 'input_field', 'label' => false));  ?>
							</div>
						</div>
						
						<!-- <div class="col-lg-6 col-sm-12 col-xs-12">
							<div class="form_block" style="line-height: 90px;">
								<a class="btn btn-primary" data-toggle="modal" data-target="#alertModel"><i class="fa fa-plus"></i> Add Alert</a>
							</div>
						</div> -->
					</div>
					...
					<div class="row">
						<div class="col-lg-12 col-sm-12 col-xs-12">
							<div class="form_block">
								...
								<div class="row">
									<div class="col-lg-3">
										<?php echo $this->Form->input('schdulecount', array('type'=>'number','min'=>0,'class' => 'input_field', 'label' => false));  ?>
									</div> 
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
        <?php echo $this->Form->create('AlertTypes',['id'=>'alert_type','url'=>'/admin/settings/add_alert_type']); ?>
		<div class="global_form">
			<div class="row">
