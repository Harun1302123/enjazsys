					...
					<div class="row">						
							<div class="col-lg-6 col-sm-12 col-xs-12">
								<div class="form_block">
								  ...
								  <?php echo $this->Form->input('trade_license_issue_date_cus', array('required' => 'required', 'class' => 'input_field', 'label' => false,'id'=>'trade_lic_issue_date'));  ?>
								</div>
							</div>  
							...
							<div class="col-lg-6 col-sm-12 col-xs-12">
								<div class="form_block">
								  ...
								  <?php echo $this->Form->input('trade_license_expiry_date_cus', array('required' => 'required', 'class' => 'input_field', 'label' => false,'id'=>'trade_lic_expire_date'));  ?>
								</div>
							</div>						
					</div>
					...
					<div class="row">
						...
						<div class="col-lg-6 col-sm-12 col-xs-12">
							<div class="form_block">
							  ...
							  <?php echo $this->Form->input('immigration_card_issue_date_cus', array('required' => 'required', 'class' => 'input_field', 'label' => false,'id'=>'immigra_card_issue_date'));  ?>
							</div>
						</div>
					</div>	
					...
					<div class="row">					
						<div class="col-lg-6 col-sm-12 col-xs-12">
							<div class="form_block">
							  ...
							  <?php echo $this->Form->input('immigration_card_expiry_date_cus', array('required' => 'required', 'class' => 'input_field', 'label' => false,'id'=>'immigra_card_expiry_date'));  ?>
							</div>
						</div>
					...
					<div class="row">						
						...
						<div class="col-lg-6 col-sm-12 col-xs-12">
							<div class="form_block">
							  ...
							  <?php echo $this->Form->input('dubai_chember_expiry_date_cus', array('required' => 'required', 'class' => 'input_field', 'label' => false,'id'=>'dubai_chamber_expire_date'));  ?>
							</div>
						</div>
					</div>
					...
					<div class="row">
						<div class="col-lg-6 col-sm-12 col-xs-12">
							<div class="form_block">
							  ...
							  <?php echo $this->Form->input('contract_start_date_cus', array('required' => 'required', 'class' => 'input_field', 'label' => false,'id'=>'contract_start_date'));  ?>
							</div>
						</div>
						...
						<div class="col-lg-6 col-sm-12 col-xs-12">
							<div class="form_block">
							  ...
							  <?php echo $this->Form->input('contract_end_date_cus', array('required' => 'required', 'class' => 'input_field', 'label' => false,'id'=>'contract_end_date'));  ?>
							</div>
						</div>
					</div>
