    ...
    <section class="content">
      ...
      <h2 class="global_title"><i class="fa fa-building-o"></i> Edit Employee</h2>
		<div class="main_info_sec">	
            <?php echo $this->Form->create($employee,array('id' => 'fileupload', 'class' => 'form-horizontal form-request check-form add-property {is_required:"false"}  js-normal-fileupload', 'enctype' => 'multipart/form-data'));?>
					...
					<div class="row">
						...
						<div class="col-lg-6 col-sm-12 col-xs-12">
							<div class="form_block">
							  ...
							  <?php echo $this->Form->input('company_id', array('options'=>$companies,'required' => 'required', 'class' => 'input_field', 'label' => false ,'value' =>$employee['company_id']));  ?>
							</div>
						</div>
					</div>
					...
					<div class="row">
						<div class="col-lg-6 col-sm-12 col-xs-12">
							<div class="form_block">
							  ...
							  <?php echo $this->Form->input('work_permit_exp_date_cus', array('required' => 'required', 'class' => 'input_field date_expiry', 'label' => false ,'value' =>$work_permit_exp_date));  ?>
							</div>
						</div>
					...
					<div class="row">
						<div class="col-lg-6 col-sm-12 col-xs-12">
							<div class="form_block">
							    ...
							    <?php echo $this->Form->input('labor_card_exp_date_cus', array('required' => 'required', 'class' => 'input_field date_expiry', 'label' => false ,'value' =>$labor_card_exp_date));  ?>
							</div>
						</div>
							...
							<div class="form_block">
								...
								foreach($employee['documents'] as $ca){
									...
									<?php } else { ?>
										...
										<a href='<?php echo BASE_URL."/client/employees/deleteEmployeeDocument/".base64_encode($ca->id);?>' onclick="javascript:return confirm('Are you sure you want to delete this, it cannot be undo?');" >Delete</a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
