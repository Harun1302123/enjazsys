    ...
    <div class="card-header border-0 pt-6">
        ...
        <div class="card-toolbar">
            ...
            <div class="d-flex justify-content-end" data-kt-user-table-toolbar="base">
                ...
                <!--begin::Add user-->
                <button class="btn btn-primary" id="create-xls-employees">
                ...
                <table class="table table-bordered table-striped table-condensed flip-content" id="kt_table_employees">
                    ...
                    <!--end::Modal - New Card-->
                        ...
                        <tr>
                            ...
                            <td class="text-center" style="width:10%">
                                <a href="#" data-bs-toggle="modal" data-bs-target="#documents-verifcation_<?php echo $employee->id; ?>">
                                    <i class="fa fa-file " aria-hidden="true"></i>
                                </a>

                                <a href="#" data-bs-toggle="modal" data-bs-target="#documents-view_<?php echo $employee->id; ?>">
                                ...
                                <div class="modal fade" id="documents-verifcation_<?php echo $employee->id; ?>" tabindex="-1" aria-hidden="true">
                                    <!--begin::Modal dialog-->
                                        ...
                                        <div class="modal-content">
                                            ...
                                            <?php
                                                ...
                                                echo $this->Form->create(
                                                    $employee,
                                                    array('url' => '/client/employees/edit/'.base64_encode($employee->id))
                                                );
                                            ?>
                                                ...
                                                <!--begin::Input row-->
                                                    ...
                                                    <table class="table table-row-bordered table-row-gray-300 gy-5">
                                                        <tr class="fw-semibold fs-6 text-gray-800 border-bottom border-gray-200">
                                                            ...
                                                            <td><label class="form-label">Sent:</label>
                                                                </br>
                                                                    <?php
                                                                        echo $this->Form->input(
                                                                            ...
                                                                            array(
                                                                                ...
                                                                                'label' => false,
                                                                                'type'=>'checkbox',
                                                                                'disabled' => $employee['clients_document']['passport_send_client'] == 1 ? 'disabled' : false
                                                                            )
                                                                        );
                                                                        ...
                                                                        echo $this->Form->input(
                                                                            ...
                                                                            array(
                                                                                'type'=>'hidden',
                                                                                'value' => $employee['clients_document']['passport_send_client_date']
                                                                            )
                                                                        );
                                                                    ?>
                                                            ...
                                                            <?php 
                                                                echo $this->Form->input('clients_document.passport_receive_client', array('class' => 'regular-checkbox persnal-doc-check form-check-input', 'label' => false, 'type'=>'checkbox' ,'disabled' => $employee['clients_document']['passport_receive_client'] == 1 ? 'disabled' : false ));
                            ...
                            <tr>
                              ...
                              <td width="45%">Sent</br>
                                <?php echo $this->Form->input('clients_document.bc_send_client', array('class' => 'regular-checkbox persnal-doc-check form-check-input', 'label' => false, 'type'=>'checkbox' ,'disabled' => $employee['clients_document']['bc_send_client'] == 1 ? 'disabled' : false ));
					...
					?>
                              ...
                              <td width="45%"> Received</br>
                                <?php echo $this->Form->input('clients_document.bc_receive_client', array('class' => 'regular-checkbox persnal-doc-check form-check-input', 'label' => false, 'type'=>'checkbox' ,'disabled' => $employee['clients_document']['bc_receive_client'] == 1 ? 'disabled' : false ));
					...
					?>
                            ...
                            <tr>
                              ...
                              <td width="45%">Sent</br>
                                <?php echo $this->Form->input('clients_document.mc_send_client', array('class' => 'regular-checkbox persnal-doc-check form-check-input', 'label' => false, 'type'=>'checkbox' ,'disabled' => $employee['clients_document']['mc_send_client'] == 1 ? 'disabled' : false ));
					...
					?>
                                ...
                                <?php }?></td>
                              <td width="45%"> Received</br>
                                <?php echo $this->Form->input('clients_document.mc_receive_client', array('class' => 'regular-checkbox persnal-doc-check form-check-input', 'label' => false, 'type'=>'checkbox'  ,'disabled' => $employee['clients_document']['mc_receive_client'] == 1 ? 'disabled' : false ));
					...
					?>
                            ...
                            <tr>
                              ...
                              <td width="45%">Sent</br>
                                <?php 
                                    echo $this->Form->input(
                                        'clients_document.eid_send_client', 
                                        array(
                                            'class' => 'regular-checkbox persnal-doc-check form-check-input', 
                                            'label' => false, 
                                            'type'=>'checkbox', 
                                            'disabled' => $employee['clients_document']['eid_send_client'] == 1 ? 'disabled' : false 
                                        )
                                    );
								 
                                 echo $this->Form->input('clients_document.eid_send_client_date', array('type'=>'hidden',
                                  'value' => $employee['clients_document']['eid_send_client_date'] ));  ?> 
                                  <span class="documents_date"> 
                                    <span class="date">
                                <?php 
                                ...
                                <?php
                                    if($employee['clients_document']['eid_receive_admin']){
                                        echo '<span class="doc-status" ><i class="btn btn-primary btn-sm fas fa-check-square" aria-hidden="true"></i> Received ('.$this->DateC->DateFormetforView($employee['clients_document']['eid_receive_admin_date']).')</span>';
                                    }
                                ?>
                                </span>
                                ...
                                <?php }?></td>
                              <td width="45%"> Received</br>
                                <?php echo $this->Form->input('clients_document.eid_receive_client', array('class' => 'regular-checkbox persnal-doc-check form-check-input', 'label' => false, 'type'=>'checkbox'  ,'disabled' => $employee['clients_document']['eid_receive_client'] == 1 ? 'disabled' : false ));
					...
					?>
                            ...
                            <tr>
                              ...
                              <td width="45%">Sent</br>
                                <?php echo $this->Form->input('clients_document.dc_send_client', array('class' => 'regular-checkbox persnal-doc-check form-check-input', 'label' => false, 'type'=>'checkbox' ,'disabled' => $employee['clients_document']['dc_send_client'] == 1 ? 'disabled' : false ));
					...
					?>
                                ...
                                <?php }?></td>
                              <td width="45%"> Received</br>
                                <?php echo $this->Form->input('clients_document.dc_receive_client', array('class' => 'regular-checkbox persnal-doc-check form-check-input', 'label' => false, 'type'=>'checkbox' ,'disabled' => $employee['clients_document']['dc_receive_client'] == 1 ? 'disabled' : false ));
					...
					?>
                            ...
                            <tr>
                              ...
                              <td width="45%">Sent</br>
                                <?php echo $this->Form->input('clients_document.medical_send_client', array('class' => 'regular-checkbox persnal-doc-check form-check-input', 'label' => false, 'type'=>'checkbox' ,'disabled' => $employee['clients_document']['medical_send_client'] == 1 ? 'disabled' : false ));
					...
					?>
                                ...
                                <?php }?></td>
                              <td width="45%"> Received</br>
                                <?php echo $this->Form->input('clients_document.medical_receive_client', array('class' => 'regular-checkbox persnal-doc-check form-check-input', 'label' => false, 'type'=>'checkbox' ,'disabled' => $employee['clients_document']['medical_receive_client'] == 1 ? 'disabled' : false));
                            ...
                            <tr>
                              ...
                              <td width="45%">Sent</br>
								...
								$class =  $employee['clients_document']['other_receive_value'] != '' ? '' : 'other_doc' ;
								 echo $this->Form->input('clients_document.other_send_client', array('class' => "regular-checkbox persnal-doc-check form-check-input  $class", 'label' => false, 'type'=>'checkbox' ,'disabled' => $employee['clients_document']['other_send_client'] == 1 ? 'disabled' : false ));  ?>
...
echo $this->Form->input('clients_document.other_receive_client', array('class' => "regular-checkbox persnal-doc-check form-check-input $class ", 'label' => false, 'type'=>'checkbox' ,'disabled' => $employee['clients_document']['other_receive_client'] == 1 ? 'disabled' : false ));
 ...
 ?>
					...
					?>
                                ...
                                <div class="modal fade" id="documents-view_<?php echo $employee->id; ?>" tabindex="-1" aria-hidden="true">
                                    <!--begin::Modal dialog-->
                                    <div class="modal-dialog modal-dialog-centered mw-650px" role="document">
                                        <!--begin::Modal content-->
                                        <div class="modal-content">
                                                      ...
                                                      <div class="col-md-6 col-lg-4 col-xl-4">
                                                            ...
                                                            <div class="card h-100">
                                                                <div class="card-body d-flex justify-content-center text-center flex-column p-8">
                                                                    ...
                                                                    <a target="_blank" href="<?php echo Router::fullBaseUrl();?>/client/employees/files/<?php echo base64_encode($ca->id); ?>"><img src='<?php echo Router::fullBaseUrl();?>/attachments/center/img.png' style='width:100px;height:100px;'></a>
                                                                    <?php } else { ?>
                                                                    <a target="_blank"  href="<?php echo Router::fullBaseUrl();?>/client/employees/files/<?php echo base64_encode($ca->id); ?>"><img src='<?php echo Router::fullBaseUrl();?>/attachments/center/text.png' style='width:100px;height:100px;'></a>
                                                                    <?php }	?>
                                                                    <br>
                                                                    <a style="color: #3c8dbc;"  href='<?php echo Router::fullBaseUrl()."/client/employees/DownloadEmployeeDocument/".base64_encode($ca->id);?>' >Download</a>
                                                                </div>
                                                            </div>
                                                        </div>
                                                        <?php
...
<?php echo $this->Html->script('client/search_report', ['block'=>'scriptBottom']); ?>
