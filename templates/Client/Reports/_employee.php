          ...
          <div class="row">
            ...
            <div class="col-md-3">
              <div class="form_block">
                ...
                <?php
					 echo $this->Form->input('expired_type',array('options'=>[''=>'Select Type','passport_expired'=>'Passport Expired','visa_expired'=>'Visa Expired' , 'emirates_id_expired' => 'Emirates ID Expired', 'labor_card_expired' => 'Labor Card Expired' , 'work_permit_exp_date' => 'Work Permit' , 'entry_permit_exp_date' => 'Entry Permit' , 'aa' => 'Insurance'], 'class' => 'input_field','label' => false ));  ?>
              </div>
            </div>
           ...
           <div class="col-md-3">
             ...
             <div class="col-md-3">
              <div class="form_block">
                ...
                <?php
					 echo $this->Form->input('status',array('options'=>[''=>'Select Status','0'=>'Canceled' , 1 => 'Active'], 'class' => 'input_field','label' => false ));  ?>
              </div>
            </div>
            ...
            <thead>
              <tr>
                ...
                <th align='left'><?php echo $this->Paginator->sort('mobile_no', 'MOBILE NO.');?></th>
				 ...
				 <th align='left'><?php echo $this->Paginator->sort('employee_entity', 'Employee Entity');?></th>
              ...
              <?php if(!$full_trans_records->isEmpty()){
				...
				?>
              <tr>
                <td><?php echo (isset($_GET['for_whom']) && $_GET['for_whom'] == 2) ? $full_trans_record['employee']['company']['name'] : $full_trans_record['company']['name'];?></td>
                ...
                <td><?php echo (isset($_GET['for_whom']) && $_GET['for_whom'] == 2) ? $full_trans_record->employee->email : $full_trans_record['email'];?></td>
                <td><?php echo (isset($_GET['for_whom']) && $_GET['for_whom'] == 2) ? $full_trans_record->employee->mobile_no : $full_trans_record['mobile_no']; ?></td>
...
<script>
	...
	if(flag){
		...
		var target = webroot+'/client/reports/employee_excel_report';
