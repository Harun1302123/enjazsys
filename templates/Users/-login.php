...
<div class="container">
    <div class="login-container">
        <div id="output"></div>
        <div class="avatar"><img src="<?php echo $this->request->getAttribute('webroot'); ?>img/daman-logo-OL.png">
        </div>
        <div class="form-box">
...
<style>
    body {
        background-image: url("<?php echo $this->request->getAttribute('webroot'); ?>img/business.jpg");
