<header class="main-header">
    ...
    <a href="<?php echo BASE_URL;?>" class="logo">
      ...
      <span class="logo-mini"><img src="<?php echo $this->request->getAttribute('webroot'); ?>img/daman-logo-OL.png" style="height: 45px;margin-top: -6px;"></span>
      <!-- logo for regular state and mobile devices -->
      <span class="logo-lg"><img src="<?php echo $this->request->getAttribute('webroot'); ?>img/daman-logo-OL.png" style="height: 45px;margin-top: -6px;"></span>
    </a>
<script>
