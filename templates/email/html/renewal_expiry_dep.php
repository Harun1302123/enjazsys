          ...
          <tr>
            <td class="content-wrap"><table width="100%" cellpadding="0" cellspacing="0">
                ...
                <tr>
				  ...
				  <b>Dear <?php echo $row->employee->name ?>,</b><br></td>
                </tr>
                <tr>
                   <td class="content-block"><br>
					We would like to notify you that the visa of <?php echo $row->name; ?> is due for renewal on or before <?php echo $row->visa_exp_date; ?>. Visa processing approximately takes around 10 working days, hence please ensure you provide us with the below documentation:
						<ul>
							<li>Passport copy.</li>
							<li>Emirates ID copy.</li>
							<li>Recent Picture with white background.</li>
							<li>Attested Tenancy Contract(Ejari)</li>
...
</body> <?php //echo '<pre>'; print_r($row); exit;?>
</html>
<?php //echo 'sddd'; exit; ?>
<style></style>
